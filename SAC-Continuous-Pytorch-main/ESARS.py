...
class TrainSpeedControl(Env):
    ...
    def step(self, action):
        ...
        if self.position >= self.speed_limit_positions[1] and self.velocity < 0.01:
          self.reward += 1
        ...
        state = np.hstack([self.position, self.velocity, self.prev_acceleration, self.current_speed_limit,
